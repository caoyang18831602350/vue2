    ...
    <div class="date-list">
      ...
      >
        <div
          ...
          v-bind:class="{'tag-date': tagDate.indexOf(day.dateFormat) != -1,'choosed-day': day.dateFormat == choosedDay.dateFormat,'today':day.dateFormat == today.dateFormat && lang == 'zh'}"
